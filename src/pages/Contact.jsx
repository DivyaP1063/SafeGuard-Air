...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen max-md:items-center">
      ...
      <div className="md:w-[60%] w-full bg-primary p-6 md:pt-[100px] flex flex-col justify-center items-center max-md:mt-[100px]">
        ...
        <form
          ...
          className="space-y-4 max-md:w-full md:w-[50%]"
        >
