...
const AboutUs = () => {
  ...
  return (
    <div className="bg-white text-primary min-h-screen flex flex-col items-center">
      ...
      <div className="pt-[120px] bg-primary w-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-50 p-5 md:p-8 rounded-xl">
            <p className="text-gray-500 uppercase mb-2">
              WELCOME TO SAFEGUARD AIR
            </p>
            <h3 className="text-xl md:text-3xl font-bold mb-6">
              ADVANCED AIR PURIFICATION & MONITORING SOLUTIONS
            </h3>
            <p className="text-gray-600 mb-8">
              At SafeGuard, we are committed to creating healthier indoor
              environments with cutting-edge air purification and monitoring
              technology. Our innovative solutions help you breathe cleaner air.
            </p>
            <div
              onClick={() => handleScroll("contactus")}
              className="inline-block bg-primary text-white font-medium py-2 px-6 hover:bg-gray-800 transition-colors"
            >
              LEARN MORE
            </div>
      ...
      <section className="py-10 bg-gray-50 w-full flex flex-col items-center text-center">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl px-4">
          SafeGuard Air is dedicated to providing high-performance air
          purification and monitoring products that improve indoor air quality.
        </p>

        <div
          onClick={() => handleScroll("products")}
          className="inline-block bg-primary text-white font-medium py-2 px-6 mb-8 hover:bg-gray-800 transition-colors"
        >
          EXPLORE PRODUCTS
        </div>
      </section>
        ...
        <div className="w-[90%] px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                SafeGuard Air is redefining air purification with smart,
                sensor-driven technology that adapts to your surroundings.
              </p>

              <div className="mb-8">
                <p className="italic text-gray-500 mb-4">
                  "The future of clean air lies in intelligent solutions that
                  not only purify but also educate users."
                </p>
      ...
      <section className="bg-primary text-white py-16 w-full">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Experience the power of SafeGuard’s advanced air purification
            technology.
          </p>
          <div
            onClick={() => handleScroll("contactus")}
            className="inline-block border border-white text-white font-medium py-2 px-6 hover:bg-white hover:text-black transition-colors"
          >
            GET STARTED
          </div>
        </div>
