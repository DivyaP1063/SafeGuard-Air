...
const Productswipe = () => {
  ...
  useEffect(() => {
    productRefs.current.forEach((item, index) => {
      if (item) {
        const image = item.querySelector(".product-img");
        const text = item.querySelector(".product-text");
            ...
            <div className="flex flex-col  w-full h-fit">
              {products.map((product, index) => (
                <div
                  ...
                  className={`product-item flex flex-col md:flex-row justify-between items-center ${
