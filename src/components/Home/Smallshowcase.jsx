...
const Smallshowcase = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-[90%] mx-auto flex flex-col md:flex-row items-center justify-between bg-white   gap-10"
    >
      {/* Text Section */}
      <div
        ref={textRef}
      ...
      >
        ...
        <p className="text-gray-600 text-lg md:text-xl mt-3">
          Experience fresh and clean air with our latest smart air quality
          identifier. Designed to show Air Quality Index.
        </p>
        <button
